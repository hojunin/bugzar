...
export function Bugzar({
  ...
  // Corner inset (px) shared by the position CSS variables and the picker bar.
  ...
  const startPick = useCallback(() => {
    ...
    pickRef.current = startDesignPick({
      position,
      ...(offset === undefined ? {} : { offset: { x: offX, y: offY } }),
  ...
  }, [onAnnotate, deliver, wantsHtml, mask, position, offset, offX, offY]);
