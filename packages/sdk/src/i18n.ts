...
const EN: Strings = {
  ...
  aiPolishing: 'AI is writing…',
  aiPolishAria: 'Write with AI',
  aiUnavailable: 'Writing with AI is unavailable right now — edit the fields and publish manually.',
  aiStubbed:
...
const KO: Strings = {
  ...
  aiPolish: '✨AI로 작성',
  aiPolishing: 'AI가 작성 중…',
  aiPolishAria: 'AI로 작성',
  aiUnavailable: 'AI 작성을 지금은 쓸 수 없어요 — 직접 입력하고 발행하세요.',
